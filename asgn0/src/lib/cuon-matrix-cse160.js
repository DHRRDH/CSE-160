...
class Vector3 {
    ...
    /**
      ...
      */
    static cross(a, b) {
        let x = a.elements[1] * b.elements[2] - a.elements[2] * b.elements[1];
        let y = a.elements[2] * b.elements[0] - a.elements[0] * b.elements[2];
        let z = a.elements[0] * b.elements[1] - a.elements[1] * b.elements[0];
